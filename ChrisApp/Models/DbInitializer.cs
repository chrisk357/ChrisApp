    ...
    public static class DbInitializer
    {
        public static void Seed(AppDbContext context)
        {
            if(!context.Slimes.Any())
            {
                context.AddRange
                    (
                    new Slime { Id = 1, Name = "Butter Slime", Price = 4.99M, ShortDescription = "The Classic Butter Slime", 
                    ...
                    new Slime { Id = 2, Name = "Unicorn Snot", Price = 12.99M, ShortDescription = "Sparkly Exotic Rare Slime",
                    ...
                    new Slime { Id = 3, Name = "Radioactive Waste", Price = 9.99M, ShortDescription = "Bright Green Glowing Slime",
                    ...
                    new Slime { Id = 4, Name = "Magnetic Slime", Price = 6.99M, ShortDescription = "Slime With A Sticky Secret",
                        LongDescription = "While Nasa was training future Astronauts for their next space mission we were tasked out with creating their slime. With all of Nasa's resources at our disposal we created a slime that can attach itself to metal surfaces so it would not be lost in outer space!", ImageUrl = "https://www.pinterest.com/pin/384072674454146291/", ImageThumbnailUrl = "https://www.pinterest.com/pin/384072674454146291/", IsSlimeOfTheWeek = true, IsInStock = true },
                    new Slime { Id = 5, Name = "Crazy Slime", Price = 7.99M, ShortDescription = "Our Crazy Classic Slime",
                    ...
                    new Slime { Id = 6, Name = "Alien Poop", Price = 8.99M, ShortDescription = "Out Of The World Slime",
                    ...
                    new Slime { Id = 7, Name = "Engine Oil", Price = 5.99M, ShortDescription = "Straight From Nascar", 
                        LongDescription = "Hear the engines revving with this fast selling top fuel race car slime. This slime has been rated at 495 hp so hold on tight while playing with it, first or last baby", ImageUrl = "https://www.pinterest.com/pin/552183604302819115/", ImageThumbnailUrl = "https://www.pinterest.com/pin/552183604302819115/", IsSlimeOfTheWeek = false, IsInStock = true }
